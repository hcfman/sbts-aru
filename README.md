...
- **Any raspberry pi**, the raspberry pi zero series have the lowest power usage for portable usage. Rasoberry pi zero w is typically less than 20 euros.
...
- A **16-bit USB sound card** compliant with jackd. Typically all the **cirrus logic cm108** based ones work as well as the **General Plus** based ones. These can be as cheap as less than one euro. My preference is the General Plus based ones as they tend to be able to provide high mic boost gain
